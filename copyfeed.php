...
?>
	...
	<div class="wrap" id="top">
			...
			<form method="post" id="copyrightfeed_options" action="" >
				...
				<div class="tablenav">
					<div style="float: right"><a href="#wpbody"><?php _e('Top', 'copyrightfeed'); ?></a></div>
				</div>
			...
			<?php } ?>
				...
				<table summary="search" class="form-table">
					<tr valign="top">
						<td>
							<?php _e('Google Blog Search', 'copyrightfeed'); ?>
							<ul>
					...
					<tr valign="top">
						<td>
							<?php _e('IceRocket Blog Search', 'copyrightfeed'); ?>
							<ul>
					...
					<tr valign="top">
						<td>
							<?php _e('Bloglines', 'copyrightfeed'); ?>
							<ul>
					...
					<tr valign="top">
						<td>
							<?php _e('BlogPulse Search', 'copyrightfeed'); ?>
							<ul>
					...
					<tr valign="top">
						<td>
							<?php _e('Sphere Blog Posts', 'copyrightfeed'); ?>
							<ul>
				...
				<table summary="more" class="form-table">
					<tr valign="top">
						<td><?php _e('Search further with:', 'copyrightfeed'); ?> <a href="http://www.google.com/search?q=+%22<?php echo $fbcf_search_fingerprint; ?>%22&amp;btnG=Suche&amp;lr=">Google Search</a></td>
					</tr>
					<tr valign="top">
						<td><?php _e('Search further with:', 'copyrightfeed'); ?> <a href="http://search.live.com/results.aspx?q=%22<?php echo $fbcf_search_fingerprint; ?>%22&amp;form=QBNO&amp;go.x=0&amp;go.y=0&amp;go=Search">Live Search</a></td>
					</tr>
					<tr valign="top">
						<td><?php _e('Search further with:', 'copyrightfeed'); ?> <a href="http://copyscape.com/?q=<?php echo $fbcf_search_fingerprint; ?>">Copyscape</a></td>
					</tr>
				</table>
